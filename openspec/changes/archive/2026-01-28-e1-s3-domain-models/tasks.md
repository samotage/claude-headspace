...
### 2.2 Model Files
- [x] 2.2.1 Create `src/claude_headspace/models/` directory structure
- [x] 2.2.2 Create `models/__init__.py` with exports
...
- [x] 2.3.1 Define foreign key relationships (Project→Agent→Task→Turn)
- [x] 2.3.2 Define Objective→ObjectiveHistory relationship
- [x] 2.3.3 Define Event nullable FK relationships
- [x] 2.3.4 Implement cascade delete behavior (Project→Agent→Task→Turn)
- [x] 2.3.5 Implement SET NULL on Event FK deletes

### 2.4 Database Indexes
- [x] 2.4.1 Add index on agents.project_id
...
### 2.6 Migration
- [x] 2.6.1 Generate migration with `flask db migrate`
- [x] 2.6.2 Review and adjust migration file if needed
- [x] 2.6.3 Run migration with `flask db upgrade`
