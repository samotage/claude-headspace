...
## Purpose
Provides a dashboard UI for browsing, creating, editing, archiving, and deleting personas. Adds a Personas tab to the main navigation, a list page at `/personas`, and full CRUD operations via modal forms backed by REST API endpoints.
