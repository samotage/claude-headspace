# Compliance Report: e3-s7-task-instruction-completion-summary
...
| Turn summaries are intent-aware with task instruction context | ✓ | 6 intent templates + instruction_context injection |
...
- ✓ Intent-specific templates: COMMAND, QUESTION, COMPLETION, PROGRESS, ANSWER, END_OF_TASK
- ✓ Task instruction context included in turn prompts
- ✓ Reference rename across codebase (task.summary → task.completion_summary)
...
- ✓ SSE turn_summary/task_summary updates summary line independently
