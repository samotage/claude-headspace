...
- [x] 2.1 Create `PersonaType` model (`src/claude_headspace/models/persona_type.py`)
...
- [x] 2.2 Modify `Persona` model (`src/claude_headspace/models/persona.py`)
...
- [x] 2.3 Register `PersonaType` in `models/__init__.py`
  - Add import
  - Add to `__all__`
...
- [x] 2.4 Create Alembic migration (`migrations/versions/{rev}_add_persona_type_system.py`)
...
- [x] 4.3 Migration runs cleanly (upgrade + downgrade + upgrade)
- [x] 4.4 PersonaType importable from `claude_headspace.models`
