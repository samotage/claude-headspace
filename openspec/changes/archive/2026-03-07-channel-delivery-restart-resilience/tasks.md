...
- [x] 2.1 Add `_reconstruct_channel_prompted()` method to `ChannelDeliveryService`
...
- [x] 2.2 Add `_reconstruct_queue()` method to `ChannelDeliveryService`
...
- [x] 2.3 Add `_reconstruct_state()` orchestrator method
...
- [x] 2.4 Call `_reconstruct_state()` from `__init__`
...
- [x] 3.1 Test reconstruction of `_channel_prompted` — basic case
...
- [x] 3.2 Test reconstruction skips agents that already responded
