...
- [ ] 2.1.1 Add `factory-boy` to dev dependencies in `pyproject.toml`
- [ ] 2.1.2 Install updated dependencies

### 2.2 Database Lifecycle Fixtures

- [ ] 2.2.1 Create `tests/integration/__init__.py`
- [ ] 2.2.2 Create `tests/integration/conftest.py` with:
...
- [ ] 2.3.1 Create `tests/integration/factories.py` with SQLAlchemyModelFactory definitions:
...
- [ ] 2.4.1 Create `tests/integration/test_factories.py` — verify each factory produces a persistable instance
- [ ] 2.4.2 Create `tests/integration/test_persistence_flow.py` — end-to-end test:
...
- [ ] 2.4.3 Create `tests/integration/test_model_constraints.py` — verify database constraints:
...
- [ ] 2.5.1 Create `docs/testing/integration-testing-guide.md` with:
