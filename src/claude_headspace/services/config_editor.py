...
CONFIG_SCHEMA = [
    SectionSchema(
        ...
        fields=[
            ...
            FieldSchema(
                "application_url",
                "string",
                "Application URL (for browser access and notifications)",
    ...
    SectionSchema(
        ...
        fields=[
            FieldSchema(
                "enabled",
                "boolean",
                "Enable file watcher (fallback monitoring)",
                default=False,
    ...
    SectionSchema(
        ...
        fields=[
            ...
            FieldSchema(
                ...
                "integer",
                "Write retry delay in milliseconds",
                min_value=10,
                max_value=5000,
                default=100,
    ...
    SectionSchema(
        ...
        fields=[
            FieldSchema(
                "enabled",
                "boolean",
                "Enable agent reaper (cleans up dead agents)",
                default=True,
            ...
            FieldSchema(
                ...
                "integer",
                "Reap agents inactive for this many seconds",
                min_value=60,
                max_value=3600,
                default=300,
            ...
            FieldSchema(
                ...
                "integer",
                "Don't reap agents younger than this (seconds)",
                min_value=60,
                max_value=3600,
                default=300,
    ...
    SectionSchema(
        ...
        fields=[
            ...
            FieldSchema(
                "polling_interval_with_hooks",
                "integer",
                "Polling interval when hooks active (seconds)",
                min_value=10,
                max_value=600,
                default=60,
    ...
    SectionSchema(
        ...
        fields=[
            ...
            FieldSchema(
                "default_verbosity",
                "string",
                "Default response verbosity (concise, normal, detailed)",
                default="concise",
            ...
            FieldSchema(
                "auto_target",
                "boolean",
                "Auto-target sole awaiting agent",
                default=False,
    ...
    SectionSchema(
        ...
        fields=[
            FieldSchema(
                ...
                "integer",
                "Seconds between tmux pane availability checks",
                min_value=1,
                max_value=600,
                default=30,
            ...
            FieldSchema(
                "subprocess_timeout",
                "integer",
                "Timeout for tmux subprocess calls (seconds)",
                min_value=1,
                max_value=30,
                default=10,
            ...
            FieldSchema(
                "text_enter_delay_ms",
                "integer",
                "Delay between sending text and pressing Enter (ms)",
                min_value=0,
                max_value=5000,
                default=120,
    ...
    SectionSchema(
        ...
        fields=[
            FieldSchema(
                ...
                "integer",
                "Stale processing timeout (seconds)",
                min_value=60,
                max_value=7200,
                default=600,
    ...
    SectionSchema(
        ...
        fields=[
            FieldSchema(
                "health_check_interval",
                "integer",
                "Seconds between socket availability checks",
                min_value=1,
                max_value=3600,
                default=30,
            ...
            FieldSchema(
                "socket_path_prefix",
                "string",
                "Socket path prefix (must match claudec convention)",
                default="/tmp/claudec-",
    ...
    SectionSchema(
        ...
        fields=[
            ...
            FieldSchema(
                "warning_threshold",
                "integer",
                "Warning threshold (% context used)",
                min_value=0,
                max_value=100,
                default=65,
    ...
    SectionSchema(
        ...
        fields=[
            FieldSchema(
                "enabled",
                "boolean",
                "Enable macOS notifications (requires terminal-notifier)",
                default=True,
            ...
            FieldSchema(
                "rate_limit_seconds",
                "integer",
                "Minimum seconds between notifications per agent",
                min_value=0,
                max_value=60,
                default=5,
    ...
    SectionSchema(
        ...
        fields=[
            FieldSchema(
                "enabled",
                "boolean",
                "Enable activity metrics aggregation",
                default=True,
            ...
            FieldSchema(
                "retention_days",
                "integer",
                "Days to retain metric records before pruning",
                min_value=1,
                max_value=3650,
                default=30,
    ...
    SectionSchema(
        ...
        fields=[
            ...
            FieldSchema(
                "thresholds.yellow",
                "integer",
                "Yellow frustration threshold (0-10)",
                min_value=0,
                max_value=10,
                default=4,
            ...
            FieldSchema(
                "thresholds.red",
                "integer",
                "Red frustration threshold (0-10)",
                min_value=0,
                max_value=10,
                default=7,
            ...
            FieldSchema(
                "session_rolling_window_minutes",
                "integer",
            ...
            FieldSchema(
                "flow_detection.min_turn_rate",
                "integer",
                "Minimum turn rate for flow state (turns/hour)",
                min_value=1,
                max_value=60,
                default=6,
            ...
            FieldSchema(
                "flow_detection.max_frustration",
                "float",
                "Maximum frustration for flow state",
                min_value=0,
                max_value=10,
                default=3.0,
    ...
    SectionSchema(
        ...
        fields=[
            ...
            FieldSchema(
                "models.command",
                "string",
                "Model for command summaries",
                default="anthropic/claude-3-haiku",
                help_text="LLM model used for command-level summaries. Can be the same as the turn model or a slightly more capable model for better command synthesis.",
            ),
            FieldSchema(
                "models.project",
                "string",
            ...
            FieldSchema(
                "priority_scoring.debounce_seconds",
                "float",
                "Priority scoring debounce (seconds)",
                min_value=0.1,
                max_value=60,
                default=5.0,
