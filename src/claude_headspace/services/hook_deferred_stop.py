...
def _run_deferred_stop(
    ...
    from .hook_helpers import (
        broadcast_turn_created,
        execute_pending_summarisations,
        extract_transcript_content,
        get_lifecycle_manager,
        send_completion_notification,
        trigger_priority_scoring,
    )
    ...
    for delay in delays:
        ...
        agent_text = extract_transcript_content(agent_obj)
        if agent_text:
            break
    ...
    if not agent_text:
        ...
        execute_pending_summarisations(pending)
        send_completion_notification(agent_obj, task)
