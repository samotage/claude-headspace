        ...
        return jsonify(
            {
                ...
                "generated_at": turn.summary_generated_at.isoformat()
                if turn.summary_generated_at
                else None,
                "cached": True,
            }
        )
        ...
        return jsonify(
            {
                ...
                "generated_at": command.completion_summary_generated_at.isoformat()
                if command.completion_summary_generated_at
                else None,
                "cached": True,
            }
        )
